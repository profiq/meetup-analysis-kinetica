...
def store_rsvp(_, rsvp_string, db, city_provider):
    """
    ...
    :param apiutils.CityProvider city_provider: Finds city name using event ID + data in DB or coordinates + Meetup API
    """
    try:
        ...
        rsvp_record['city'] = city_provider.get_city(
